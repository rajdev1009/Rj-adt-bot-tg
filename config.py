...
class Config:
    ...
    def get_channel_url(cls) -> str:
        ...
        # Pehle explicit username check karo
        if cls.UPDATE_CHANNEL_USERNAME:
            u = cls.UPDATE_CHANNEL_USERNAME.lstrip("@")
            return f"https://t.me/{u}"
        # Agar UPDATE_CHANNEL string/username hai
        if isinstance(cls.UPDATE_CHANNEL, str) and cls.UPDATE_CHANNEL.startswith("@"):
            return f"https://t.me/{cls.UPDATE_CHANNEL.lstrip('@')}"
        # Numeric ID — URL nahi bana sakte bina username ke
        return ""
