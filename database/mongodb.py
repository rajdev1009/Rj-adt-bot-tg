...
class MongoDB:
    ...
    @classmethod
    async def delete_all_files(cls) -> int:
        """
        Saari files DB se delete karo.
        Returns: delete hue documents ki count.
        Password check caller (admin.py) mein hota hai.
        """
        result = await cls._files.delete_many({})
